...
contract CosmicSignatureToken is
	...
	/// [/Comment-202411253]
	function _checkOnlyGame() private view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019a0000, 1037618708890) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019a0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019a0004, 0) }
		if (_msgSender() != game) {
	...
	function mintMany(MintSpec[] calldata specs_) external override _onlyGame {
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100e9,0)}
	...
	function burnMany(MintSpec[] calldata specs_) external override _onlyGame {
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100ea,0)}
	...
	function mintAndBurnMany(MintOrBurnSpec[] calldata specs_) external override _onlyGame {
		...
		// #enable_smtchecker */
		{
			for ( uint256 index_ = 0; index_ < specs_.length; ++ index_ ) {
				MintOrBurnSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100ef,0)}
				int256 value_ = specReference_.value;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000f0,value_)}
				if (value_ >= int256(0)) {
	...
	function transferMany(address[] calldata tos_, uint256 value_) external override {
		address from_ = _msgSender();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000e7,from_)}
		for (uint256 index_ = tos_.length; index_ > 0; ) {
			-- index_;
			address to_ = tos_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000eb,to_)}
	...
	function transferMany(MintSpec[] calldata specs_) external override {
		address from_ = _msgSender();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000e8,from_)}
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100ec,0)}
			address to_ = specReference_.account;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000ed,to_)}
			uint256 value_ = specReference_.value;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000ee,value_)}
			_transfer(from_, to_, value_);
		}
	}
	...
	function CLOCK_MODE() public pure override returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019d0000, 1037618708893) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019d0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019d0004, 0) }
	...
	/// @notice Comment-202501123 relates and/or applies.
	function clock() public view override returns (uint48) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019e0000, 1037618708894) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019e0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019e0004, 0) }
	...
	function _update(address from_, address to_, uint256 value_) internal override (ERC20, ERC20Votes) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019b0000, 1037618708891) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019b0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019b0005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019b6002, value_) }
	...
	function nonces(address owner_) public view override (IERC20Permit, Nonces, ERC20Permit) returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019c0000, 1037618708892) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019c0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff019c6000, owner_) }
