...
abstract contract MainPrize is
	...
	function claimMainPrize() external override nonReentrant /*_onlyRoundIsActive*/ {
		...
		if (_msgSender() == lastBidderAddress) {
			...
			int256 durationUntilOperationIsPermitted_ = getDurationUntilMainPrize() + int256(timeoutDurationToClaimMainPrize);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000f8,durationUntilOperationIsPermitted_)}
			require(
	...
	function _distributePrizes() private {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a10000, 1037618708897) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a10001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a10004, 0) }
		// #region

		// This can potentially be zero.
		uint256 mainEthPrizeAmount_;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000f7,mainEthPrizeAmount_)}
...

				{
...

					{
						...
						for (uint256 luckyStakerIndex_ = luckyStakerAddresses_.length; luckyStakerIndex_ > 0; ) {
							-- luckyStakerIndex_;
							address luckyStakerAddress_ = luckyStakerAddresses_[luckyStakerIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000f9,luckyStakerAddress_)}
							...
							cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftOwnerRandomWalkNftStakerAddressIndex_ + luckyStakerIndex_] = luckyStakerAddress_;address certora_local254 = cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftOwnerRandomWalkNftStakerAddressIndex_ + luckyStakerIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000fe,certora_local254)}
						}
					}
					...
					if (lastCstBidderAddress != address(0)) {
						...
						cosmicSignatureTokenMintSpecs_ = new ICosmicSignatureToken.MintSpec[](2);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000200fa,0)}
					}
...

					{
						...
						do {
							uint256 randomNumber_ = RandomNumberHelpers.generateRandomNumber(randomNumberSeedWrapper_);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000fb,randomNumber_)}
							address raffleWinnerAddress_ = bidderAddressesReference_.items[randomNumber_ % bidderAddressesReference_.numItems];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000fc,raffleWinnerAddress_)}
							// #enable_asserts assert(raffleWinnerAddress_ != address(0));
							-- cosmicSignatureNftIndex_;
							cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftIndex_] = raffleWinnerAddress_;address certora_local255 = cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000ff,certora_local255)}
...

					{
...

						{
							...
							do {
								...
								-- cosmicSignatureNftIndex_;
								address raffleWinnerAddress_ = cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000100,raffleWinnerAddress_)}
								// #enable_asserts assert(raffleWinnerAddress_ != address(0));
						...
						while (cosmicSignatureNftIndex_ > 0) {
							-- cosmicSignatureNftId_;
							-- cosmicSignatureNftIndex_;
							address luckyStakerAddress_ = cosmicSignatureNftOwnerAddresses_[cosmicSignatureNftIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000fd,luckyStakerAddress_)}
							// #enable_asserts assert(luckyStakerAddress_ != address(0));
...

				{
...

					{
...

						{
							...
							do {
								-- ethDepositIndex_;
								IPrizesWallet.EthDeposit memory ethDepositReference_ = ethDeposits_[ethDepositIndex_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010101,0)}
								uint256 randomNumber_ = RandomNumberHelpers.generateRandomNumber(randomNumberSeedWrapper_);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000102,randomNumber_)}
								address raffleWinnerAddress_ = bidderAddressesReference_.items[randomNumber_ % bidderAddressesReference_.numItems];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000103,raffleWinnerAddress_)}
								// #enable_asserts assert(raffleWinnerAddress_ != address(0));
								ethDepositReference_.prizeWinnerAddress = raffleWinnerAddress_;address certora_local260 = ethDepositReference_.prizeWinnerAddress;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000104,certora_local260)}
								ethDepositReference_.amount = raffleEthPrizeAmountForBidder_;uint256 certora_local261 = ethDepositReference_.amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000105,certora_local261)}
	...
	function _prepareNextRound() private {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a20000, 1037618708898) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a20001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01a20004, 0) }
	...
	function getMainEthPrizeAmount() public view override returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01910000, 1037618708881) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01910001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01910004, 0) }
		// #enable_smtchecker /*
		unchecked
		// #enable_smtchecker */
		{
	...
	function getCharityEthDonationAmount() public view override returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01920000, 1037618708882) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01920001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01920004, 0) }
		// #enable_smtchecker /*
		unchecked
		// #enable_smtchecker */
		{
