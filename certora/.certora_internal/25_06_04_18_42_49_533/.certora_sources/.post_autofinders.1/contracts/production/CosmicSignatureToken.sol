...
contract CosmicSignatureToken is
	...
	/// [/Comment-202411253]
	function _checkOnlyGame() private view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02b90000, 1037618709177) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02b90001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02b90004, 0) }
		if (_msgSender() != game) {
	...
	function mintMany(MintSpec[] calldata specs_) external override _onlyGame {
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100a2,0)}
	...
	function burnMany(MintSpec[] calldata specs_) external override _onlyGame {
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100a3,0)}
	...
	function mintAndBurnMany(MintOrBurnSpec[] calldata specs_) external override _onlyGame {
		...
		// #enable_smtchecker */
		{
			for ( uint256 index_ = 0; index_ < specs_.length; ++ index_ ) {
				MintOrBurnSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100a8,0)}
				int256 value_ = specReference_.value;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a9,value_)}
				if (value_ >= int256(0)) {
	...
	function transferMany(address[] calldata tos_, uint256 value_) external override {
		address from_ = _msgSender();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a0,from_)}
		for (uint256 index_ = tos_.length; index_ > 0; ) {
			-- index_;
			address to_ = tos_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a4,to_)}
	...
	function transferMany(MintSpec[] calldata specs_) external override {
		address from_ = _msgSender();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a1,from_)}
		for (uint256 index_ = specs_.length; index_ > 0; ) {
			-- index_;
			MintSpec calldata specReference_ = specs_[index_];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000100a5,0)}
			address to_ = specReference_.account;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a6,to_)}
			uint256 value_ = specReference_.value;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff000000a7,value_)}
			_transfer(from_, to_, value_);
		}
	}
	...
	function CLOCK_MODE() public pure override returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bc0000, 1037618709180) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bc0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bc0004, 0) }
	...
	/// @notice Comment-202501123 relates and/or applies.
	function clock() public view override returns (uint48) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bd0000, 1037618709181) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bd0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bd0004, 0) }
	...
	function _update(address from_, address to_, uint256 value_) internal override (ERC20, ERC20Votes) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02ba0000, 1037618709178) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02ba0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02ba0005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02ba6002, value_) }
	...
	function nonces(address owner_) public view override (IERC20Permit, Nonces, ERC20Permit) returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bb0000, 1037618709179) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bb0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bb0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02bb6000, owner_) }
