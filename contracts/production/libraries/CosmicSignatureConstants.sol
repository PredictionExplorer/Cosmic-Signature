...
library CosmicSignatureConstants {
	...
	/// [Comment-202606216]
	/// On Arbitrum Sepolia and, likely, on Arbitrum One, at least during a gas estimate call,
	/// `tx.gasprice` is zero. In that case the bidding code treats the swallow threshold as unbounded,
