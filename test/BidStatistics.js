...
describe("BidStatistics", function () {
	...
	it("Bid duration accounting: 2 bidders place bids of different durations", async function () {
		...
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid1

		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_001_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid2
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_006_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid3
				
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_007_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid4

		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_008_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid5
	...
	it("Bid duration accounting: 3 bidders place bids of equal durations", async function () {
		...
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[3]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid3
		...
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid6
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_006_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[3]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid7
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_007_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid8
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_008_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid9
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_009_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid10
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_010_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid11
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_011_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid12
		
		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_012_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid13
	...
	it("Endurance Champion selection is correct for a specific use case", async function () {
		...
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[0]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid1 (for 1,000 seconds)

		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_081_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[1]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid2 (for 2,000 seconds)

		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_083_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[2]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid3 (for 5,000 seconds)

		await hre.ethers.provider.send("evm_setNextBlockTimestamp", [100_000_088_000]);
		// await hre.ethers.provider.send("evm_mine");
		await contracts_.cosmicSignatureGameProxy.connect(contracts_.signers[3]).bidWithEth(-1n, "", {value: 10n ** 18n,}); // bid4 (close everything)
