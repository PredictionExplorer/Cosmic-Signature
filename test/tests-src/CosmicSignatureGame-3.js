...
describe("CosmicSignatureGame-3", function () {
	...
	it("Upgrading CosmicSignatureGame ==> CosmicSignatureGameV2 ==> CosmicSignatureGameV3 ==> CosmicSignatureGameOpenBid", async function () {
		...
		expect(cosmicSignatureGameV2ImplementationByteCodeSize_).greaterThanOrEqual(19 * 1024);
		console.info(
			"%s",
		...
		expect(cosmicSignatureGameV3ImplementationByteCodeSize_).greaterThanOrEqual(19 * 1024);
		console.info(
			"%s",
