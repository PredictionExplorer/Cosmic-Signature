...
// exactly (prices, sqrt CST reward, CST Dutch-auction duration drift, the V3 late-bid price premium,
// mainPrize timing, champion automaton, round advancement, the V3 multi-NFT main prize), and
// `ShadowState` ledgers track every ETH/CST/NFT/donation flow.
