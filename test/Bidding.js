...
describe("Bidding", function () {
	...
	it("A bid reverts if minting of Cosmic Signature Tokens does (first mint)", async function () {
	...
	it("A bid reverts if minting of Cosmic Signature Tokens does (second mint)", async function () {
		const contracts_ = await loadFixtureDeployContractsForUnitTesting(-1_000_000_000n);
