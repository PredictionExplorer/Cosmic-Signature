...
async function main() {
	...
	let params = ethers.utils.defaultAbiCoder.encode(['uint256'],[2]);
	await cosmicGameProxy.connect(testingAcct).proxyCall('0x57a23952',params, {gasLimit: 30000000 }); // call setTimesBidPrice() function
}
main()
	.then(() => process.exit(0))
	.catch(error => {
