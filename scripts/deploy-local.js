...
async function main() {
  ...
  const {cosmicGame, cosmicToken, cosmicSignature, charityWallet, cosmicDAO, raffleWallet, randomWalkNFT,bidLogic    } = await basicDeployment(deployerAcct,"",0,'0x1b2E85De21C7CF4bD1787c6Ac4bd505e83b62Ba5',true);
