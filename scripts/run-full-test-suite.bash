...
RW_TOKENS=$(PRIVKEY=$CG_PRIVKEY COSMIC_SIGNATURE_GAME_ADDRESS=$CONTRACT_ADDR npx hardhat run scripts/mint-random-walk-nfts.js --network $CG_NETWORK)
echo Random walk NFTs: $RW_TOKENS
RWALK_TOKENS=$RW_TOKENS PRIVKEY=$CG_PRIVKEY COSMIC_SIGNATURE_GAME_ADDRESS=$CONTRACT_ADDR npx hardhat run scripts/test-deployment-part-1.js --network $CG_NETWORK
PRIVKEY=$CG_PRIVKEY COSMIC_SIGNATURE_GAME_ADDRESS=$CONTRACT_ADDR npx hardhat run scripts/forward-time-to-main-prize-time.js --network $CG_NETWORK
PRIVKEY=$CG_PRIVKEY COSMIC_SIGNATURE_GAME_ADDRESS=$CONTRACT_ADDR npx hardhat run scripts/test-deployment-part-2.js --network $CG_NETWORK
