...
// todo-1 This should return `{cosmicSignatureGameAddress, cosmicSignatureGame}`.
...
// todo-1 This should return `{bidderContractAddress, bidderContract}`.
async function getBidderContract() {
	...
	// console.info(bidderContractAddress);
