...
(
	...
	if [ ${OutcomeCode} -lt 2 ]; then
		...
		export HARDHAT_NETWORK='hardhat_on_localhost'
		...
		'node' '../../scripts/transfer-eth.js' '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266' '0x1A7C40ed72789d777abA9692C32de20710E1A29A' '0.2'
