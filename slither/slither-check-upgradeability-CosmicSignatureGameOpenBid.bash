...
(
	...
	if [ ${OutcomeCode} -lt 2 ]; then
		...
		"${SlitherFolderPath}slither-check-upgradeability" '..' '--hardhat-artifacts-directory' 'artifacts/production' 'CosmicSignatureGame' '--new-contract-name' 'CosmicSignatureGameOpenBid'
		if [ $? -ne 0 ]; then
