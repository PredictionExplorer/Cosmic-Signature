...
(
	...
	'npx' 'hardhat' 'upgrade-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-arbitrumSepolia-CosmicSignatureGameV2.json' '--network' 'arbitrumSepolia'
	if [ $? -ne 0 ]; then
