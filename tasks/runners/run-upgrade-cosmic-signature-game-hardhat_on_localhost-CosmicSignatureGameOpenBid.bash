...
(
	...
	'npx' 'hardhat' 'upgrade-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-hardhat_on_localhost-CosmicSignatureGameOpenBid.json' '--network' 'hardhat_on_localhost'
	if [ $? -ne 0 ]; then
