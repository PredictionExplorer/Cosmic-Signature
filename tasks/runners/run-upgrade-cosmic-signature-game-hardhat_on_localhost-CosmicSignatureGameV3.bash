...
(
	...
	'npx' 'hardhat' 'upgrade-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-hardhat_on_localhost-CosmicSignatureGameV3.json' '--network' 'hardhat_on_localhost'
	if [ $? -ne 0 ]; then
