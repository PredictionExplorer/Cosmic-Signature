...
(
	...
	'npx' 'hardhat' 'deploy-cosmic-signature-contracts' '--deployconfigfilepath' '../config/deploy-cosmic-signature-contracts-config-arbitrumSepolia.json' '--network' 'arbitrumSepolia'
	if [ $? -ne 0 ]; then
