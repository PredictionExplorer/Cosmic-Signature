...
(
	...
	'npx' 'hardhat' 'register-upgraded-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-arbitrumSepolia-CosmicSignatureGameOpenBid.json' '--network' 'arbitrumSepolia'
	if [ $? -ne 0 ]; then
