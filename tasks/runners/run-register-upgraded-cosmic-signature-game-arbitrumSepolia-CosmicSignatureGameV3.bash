...
(
	...
	'npx' 'hardhat' 'register-upgraded-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-arbitrumSepolia-CosmicSignatureGameV3.json' '--network' 'arbitrumSepolia'
	if [ $? -ne 0 ]; then
