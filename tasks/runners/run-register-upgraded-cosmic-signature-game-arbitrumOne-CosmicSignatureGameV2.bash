...
(
	...
	'npx' 'hardhat' 'register-upgraded-cosmic-signature-game' '--upgradeconfigfilepath' '../config/upgrade-cosmic-signature-game-config-arbitrumOne-CosmicSignatureGameV2.json' '--network' 'arbitrumOne'
	if [ $? -ne 0 ]; then
